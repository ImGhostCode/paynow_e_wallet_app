...
class ResponseToFrUsecase extends UseCase<void, ResponseToFrParams> {
  final ContactRepository repository;

  ResponseToFrUsecase(this.repository);

  @override
  Future<Either<Failure, void>> call(ResponseToFrParams params) async {
    final result = await repository.respondToFriendRequest(params);
